...
function vstick_draw(argument0) {
	...
	{
	    draw_sprite_ext(vstick[argument0,13],0,vstick[argument0,3],vstick[argument0,4],stickscale,stickscale,0,c_white,defalph);
	}
	...
	{
	    draw_sprite_ext(vstick[argument0,14],0,vstick[argument0,3]+vstick[argument0,11]*vstick[argument0,2],vstick[argument0,4]+vstick[argument0,12]*vstick[argument0,2],stickscale,stickscale,0,c_white,defalph);
	}
