...
{
	if (image_index>=7) {
if instance_exists(myvictim) {
	instance_create_layer(myvictim.x,myvictim.y-5,"BefEdge",oNippy);
	myvictim.alarm[11]=1;}

	}
if (image_index>=11) { attack=false;
	sprite_index=sSealAFK; alarm[0]=10; image_speed=1;
	}
}
