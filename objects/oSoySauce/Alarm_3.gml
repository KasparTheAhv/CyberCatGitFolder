...
with (instance_create_layer(x,y-17,"Gun",oBulletLamp))
{
alarm[0]=140; speed=8;direction=dir+irandom_range(-1,1); image_angle=dir+irandom_range(-1,1);
}
...
with (instance_create_layer(x,y-17,"Gun",oBulletLamp))
{
alarm[0]=140; speed=7; direction=dir; image_angle=dir;
}
